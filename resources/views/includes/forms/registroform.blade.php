...
<div class="form__d_f">
    <div class="form__100">
        ...
        <input type="text" class="form__input" name="form_name" id="form-name" min="6" max="100" value="{{old('form_name')}}"><br>
    </div>
    <div class="form__50">
        <label for="fname" class="form__label">Edad:</label><br>
        <input type="number" class="form__input" name="form_edad" id="form-edad" min="6" max="100" value="{{old('form_edad')}}">
    </div>
    <div class="form__50">
        ...
        <input type="tel" class="form__input" name="form_num" id="form-num" min="6" max="100"
            placeholder="(10 dígitos)" value="{{old('form_num')}}"><br>
    </div>
    <div class="form__50">
        ...
        <input type="email" class="form__input" name="form_email" id="form-email" min="6" max="100"
            placeholder="correo@servidor.com" value="{{old('form_email')}}"><br>
    </div>
    <div class="form__50">
        ...
        <input type="url" class="form__input" name="form_face" id="form-face" min="6" max="100"
            value="https://facebook.com/" placeholder="https://facebook.com/" value="{{old('form_face')}}"><br>
    </div>
    <div class="form__100">
        <label for="fname" class="form__label">Domicilio:</label><br>
        <input type="text" class="form__input" name="form_dom" id="form-dom" min="6" max="100" value="{{old('form_dom')}}"><br>
    </div>
</div>
...
<div class="form__d_f">
    <div class="form__50">
        ...
        <div class="form__selector">
            <select type="search" class="form__input" name="form_uni" id="form-uni" min="6" max="100" value="{{old('form_uni')}}">
    ...
    <div class="form__50">
        ...
        <input type="text" class="form__input" name="form_carrera" id="form-carrera" min="6" max="100" value="{{old('form_carrera')}}"><br>
    </div>
    <div class="form__100">
        <label for="fname" class="form__label">Escuela de procedencia:</label><br>
        <input type="text" class="form__input" name="form_escuela" id="form-escuela" min="6" max="100" value="{{old('form_escuela')}}"><br>
    </div>
    <div class="form__100">
        <label for="fname" class="form__label">¿Qué horario te interesa?</label><br>
        <div class="form__selector">
            <select type="text" class="form__input" name="form_horario" id="form-horario" min="6" max="100" value="{{old('form_horario')}}">
    ...
    <div class="form__100">
        ...
        <textarea type="text" class="form__input" name="form_cuentanos" id="form-cuentanos" min="6" max="100" value="{{old('form_cuentanos')}}"></textarea>
    </div>
</div>
...
<div class="form__d_f">
    <div class="form__100">
        ...
        <input type="text" class="form__input" name="form_csdt" id="form-csdt" min="6" max="100" value="{{old('form_csdt')}}"><br>
    </div>
    <div class="form__50">
        <label for="fname" class="form__label">Nombre de tu padre o tutor:</label><br>
        <input type="text" class="form__input" name="form_name_padre" id="form-name_padre" min="6" max="100" value="{{old('form_name_padre')}}"><br>
    </div>
    <div class="form__50">
        <label for="fname" class="form__label">Celular de tu padre o tutor:</label><br>
        <input type="tel" class="form__input" name="form_tel_padre" id="form-tel_padre" min="6" max="100" value="{{old('form_tel_padre')}}"><br>
    </div>
</div>
<div class="form__acuerdo">
    <label for="fname" class="form__label">Acuerdo legal:</label><br>
    <span class="form__option">
        <input type="checkbox" class="form__input_check" name="form_check" id="form-check" value="{{old('form_check')}}">
