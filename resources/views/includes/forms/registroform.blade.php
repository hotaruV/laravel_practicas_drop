...
<div class="form__d_f">
    ...
    <div class="form__50">
        ...
        <input type="tel" class="form__input" name="form_num" id="form-num" min="6" max="100"  value="{{ old('form_num') }}"
            placeholder="(10 dígitos)" ><br>
    </div>
    <div class="form__50">
        <label for="fname" class="form__label">E-mail:</label><br>
        <input type="email" class="form__input" name="form_email" id="form-email" min="6" max="100" value="{{ old('form_email') }}"
            placeholder="correo@servidor.com" ><br>
    </div>
    <div class="form__50">
        <label for="fname" class="form__label">Facebook:</label><br>
        <input type="url" class="form__input" name="form_face" id="form-face" min="6" max="100" value="{{ old('form_face') }}"
